                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
                            pilih = ['y ','ngapain tag tag woe, kangen?','ada apa ini? ko di tag?','duhh kena tag, dianya kesepian kali yah','gk usah tag, gift tikel aja']
                    ...
                    if msg.contentType == 0:
                        if msg.toType == 2:
                            ...
                            if text.lower() == 'me':
                                ...
                                client.sendText(receiver, "MEMBER :"+str(jml))
